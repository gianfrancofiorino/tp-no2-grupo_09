...
Private Sub Form_KeyPress(KeyAscii As Integer)
        ' cuando tengo el cartel activado en algunos casos necesito confirmacion
        'por ende me fijo que tecla se apreta y en que estado estoy ( salir o borrando
        If cartel Then
            ...
            For i = 1 To 90 ' repaso las 90 etiquetas de numero
                Frm_Number.LblNumber(i).BackColor = &HFFFFFF 'pongo todas las etiquetas con fondo blanco blanco
                Frm_Number.LblNumber(i).ForeColor = &H0         'lo pongo en negro a al letra
                bOrden(i) = False 'y lo saco del vector de orden
            Next
            j = 1
            Else
                borrartodo = False
